...
public class RestAssuredExtention {
    ...
    public RestAssuredExtention() {
        ...
        builder.setBaseUri("http://54.196.89.61/api/v3/");
    ...
    public static ResponseOptions<Response> GetOpsWithToken(String url, String token) {
        //Act
        try {
            Request.header(new Header("Authorization", "Token " + token));
    ...
    public static ResponseOptions<Response> PostWithBodyWithToken(String url,Map<String, String> body, String token)  {
        Request.header(new Header("Authorization", "Token " + token));
        Request.body(body);
        return Request.post(url);
    }
    ...
    public static ResponseOptions<Response> PostWithToken(String url, String token)  {
        Request.header(new Header("Authorization", "Token " + token));
        return Request.post(url);
    }

    public static ResponseOptions<Response> DeleteWithToken(String url, String token)  {
        Request.header(new Header("Authorization", "Token " + token));
        return Request.delete(url);
    }

    public static ResponseOptions<Response> PatchWithBodyWithToken(String url,Map<String, String> body, String token)  {
        Request.header(new Header("Authorization", "Token " + token));
        Request.body(body);
        return Request.patch(url);
    }
    public static ResponseOptions<Response> PutWithBodyWithToken(String url,Map<String, String> body, String token)  {
        Request.header(new Header("Authorization", "Token " + token));
        Request.body(body);
        return Request.put(url);
    }

    public static ResponseOptions<Response> DeleteWithBodyWithToken(String url,Map<String, String> body, String token)  {
        Request.header(new Header("Authorization", "Token " + token));
        Request.body(body);
        return Request.delete(url);
    }
